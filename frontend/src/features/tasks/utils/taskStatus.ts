...
export const TaskStatusStyles: Record<TaskStatus, string> = {
  TODO: "inline-flex items-center rounded-full border px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] bg-gray-100 text-gray-700 border-gray-200",
  ...
  IN_REVIEW:
    "inline-flex items-center rounded-full border px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] bg-purple-100 text-purple-700 border-purple-200",
  ...
  DONE: "inline-flex items-center rounded-full border px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] bg-green-100 text-green-700 border-green-200",
